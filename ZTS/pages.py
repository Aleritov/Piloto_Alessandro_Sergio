...
class ResultsPage(Page):
    ...
    def vars_for_template(self):
        pandl_val = self.player.pandl
        compensacion_variable = max(pandl_val, 0) * 0.01
        monto_fijo = 5.00
        compensacion_total = round(monto_fijo + compensacion_variable, 2)
        ...
        return dict(
            ...
            pandl=self.to_human_readable(pandl_val),
            mostrar_compensacion=(self.round_number == 2),
